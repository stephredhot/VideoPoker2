                    ...
                    ForEach(0..<5, id: \.self) { index in
                        VStack(spacing: 15) {
                            ...
                            CardView(
                                ...
                                isHeld: viewModel.gamePhase != .result && viewModel.winningHandType == nil && viewModel.heldIndices.contains(index),
                            ...
                            HoldButton(isHeld: viewModel.gamePhase != .result && viewModel.winningHandType == nil && viewModel.heldIndices.contains(index)) {
                                viewModel.toggleHold(at: index)
                            }
